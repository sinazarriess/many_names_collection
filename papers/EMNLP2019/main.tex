...
When linking to WordNet, we observe that most of the alternatives for the original name in VisualGenome cannot be retrieved via hierarchical relations, as taxonomically-related phenomena only account for a small portion of the data and
