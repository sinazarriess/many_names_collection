...
Next, we look at the following agreement measures, computed with $t>1$: 
%$t=1$: % to assess agreement on the object names:
\begin{itemize}
...
%GBT: I changed this cause I'm afraid to be left out for formal reasons. 
%\vspace{-0.5cm}
...
\begin{table*}[t]
	...
	\begin{tabular}{l@{~}|@{~}r@{~}r@{~}rr@{~}|@{~}r@{~}r@{~}rr@{~}|@{~}r@{~}r@{~}rr}
		...
		Baseline       &                3.9 &                  4.6 &                    5.6 &            6.9 &             0.1 &               3.0 &                 3.8 &         6.5 &              3.8 &                4.6 &                  5.8 &          6.9 \\
	\end{tabular}
	\caption{Baseline: The most frequent name for $=$VG, $=$MN and $\in$MN, and random distribution for KL. The numbers in parentheses give the \# instances in each set.	\label{tab:model}}
\end{table*}
%
