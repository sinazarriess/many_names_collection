...
From the original vocabulary of Bottom-up, consisting of $1,600$ object names, we removed the ones \sz{how many?} that are not found in MN, and filtered  images whose \vg name was not in the resulting vocabulary.
...
\gbt{Carina, I don't understand the following sentence} \sz{me neither}
