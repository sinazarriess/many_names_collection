...
\begin{itemize}
		...
		%We are required to have this information in order to judge whether a certain name would be informative in a certain context, i.e., whether it would apply uniquely to the target object.
\end{itemize}
