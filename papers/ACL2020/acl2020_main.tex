...
Our detailed error analysis reveals that models generally make more mistakes when human agreement is also low, with inadequate predictions due to bounding box issues being a major source of errors.
