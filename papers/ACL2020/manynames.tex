...
The blue line shows that, even after gathering 10 names, the entry-level name has been confidently identified for only 68\% of objects.
...
Both lines level level out well below 100\%, reflecting that for 15\%-20\% of objects even gathering 36 names does not allow us to confidently state which name is the entry-level name: differences in frequencies between the contenders are simply too small.
\mw{@cs, @sz: I wonder how this is / ought to be taken into account in other analyses in the paper. I lack a proper overview to be able to tell.}
