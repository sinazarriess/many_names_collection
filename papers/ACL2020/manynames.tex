...
Both lines level level out well below 100\%, reflecting that for 15\%-20\% \cs{Can you compute that individually for each domain?} of objects even gathering 36 names is not enough for the majority name to be confidently assumed to be the entry-level name: differences in frequencies between the contenders are simply too small.
