...
\gbt{BEGIN not integrated in the text yet}
...
\gbt{IMPORTANT: I would not include all four ResNet models in the main paper; it takes a lot of space in all the result tables and doesn't add much information. I'd put the most relevant (at most two, maybe even only one) in the main paper and leave the rest for the supplementary material. TBD}
