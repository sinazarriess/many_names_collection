...
Besides \textit{Hit}, the entry-level name, and \textit{Off}, a non-sensical name (none of the others), we distinguish between different \textit{Human-like mishits}:\\\vspace{-2ex}
...
\end{figure}
\fi 
\paragraph{Do Predictions Deteriorate with Agreement?}
