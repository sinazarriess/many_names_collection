...
Table \ref{tab:humanlike} shows the breakdown of the results for the error categories explained above. Here, the proportion of human-like error is suprisingly constant across all models.
...
\fi
%
None of the models predicted an inadequate name that was a linguistic, or any other error \sz{what??? no errors no more :-)}. 
