...
ManyNames v.1, the version\cs{would remove "the version"} presented in this paper, contains 36 crowd-sourced names for 25K object instances from \vgenome \cite{krishna2016visualgenome}.%
...
Picture naming norms are typically small (500-1000 images) and use idealized drawings (Figure \ref{fig:cake}, right; \cs{but see, e.g.,~\cite{brodeur2014bank} for exceptions}); ManyNames is much larger and uses real images of objects in complex visual contexts, which makes it suitable for research in L\&V.
