...
We chose a creation methodology for ManyNames to \sz{sounds slightly weird, a methodology that ... ???}overcome these shortcomings in particular.
...
It is inspired in \sz{by?} picture naming norms as developed in Psycholinguistics~\cite{snodgrass,rossion2004revisiting}, which is the field that has devoted the most attention to object naming to date.
