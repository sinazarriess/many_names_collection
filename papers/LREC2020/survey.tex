...
\end{tabular}
\label{tab:compare}
\caption{Overview statistics for different data sets containing object naming data \gbt{What is the VGmn column? Is it necessary?}}
\end{table*}
