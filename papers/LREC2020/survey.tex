...
Both datasets  \cite{Yu2016} use the \referit\cite{Kazemzadeh2014} game for collecting referring expressions (RE) for natural objects in real-world images, and are built on top of MS COCO \cite{mscoco}, 
...
We expect this dataset to be good to examine the effect of context on naming choices in a referential setting, because the images contain complex scenes with other objects of more or less similar categories, i.e.\ so-called distractors \cite{krahmer:2012}.
