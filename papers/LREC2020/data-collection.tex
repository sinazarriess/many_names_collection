...
Moreover, its object names are linked to WordNet synsets \cite{fellbaum1998wordnet}, which allows for analysis possibilities that we will exploit in Section~\ref{sec:analysis} below.
