...
\begin{figure*}[htp]
	\centering
	\includegraphics[scale=.8]{figures/distr_imgs-per-domain_VGMN.png}
	\caption{Cumulative histograms of the number of images and \sz{original VG?} names per domain in ManyNames.}
