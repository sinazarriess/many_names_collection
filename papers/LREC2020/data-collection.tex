...
% But it's not really a cumulative histogram
	\caption{Number of images per domain ManyNames. Colors are the original VG names; all high-frequency names are shown, as well as a few lower-frequency names.}
