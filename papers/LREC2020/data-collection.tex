...
Table~\ref{tab:overview_dataset1} shows the top 5 \vg names in each of the domains. \gbt{If someone feels like it: It'd be good to use small caps for domains throughout, and also to have the same (alphabetical?) order for all domains in all tables.}
