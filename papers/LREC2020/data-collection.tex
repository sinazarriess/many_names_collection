...
\begin{table*}[htp]
	...
	\begin{tabular}{@{~}l@{~}l@{~}l@{~}l@{~}l@{~}l@{~}l}
		...
		\bottomrule
	\end{tabular}
	\caption{Overview of the ManyNames dataset: Top 5 VG names for each domain (number of instances in parentheses). %\textbf{double-check}
...
%\gbt{from the dataframe it's 449. Also, there are some mistakes ('dugout.', 'man's').+++
